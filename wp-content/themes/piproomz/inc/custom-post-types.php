...
// Register Custom Post Type Currency
// Post Type Key: Currency
function pip_create_currency_cpt() {

	$labels = array(
		'name' => __( 'Currencies', 'Post Type General Name', 'text_domain' ),
		'singular_name' => __( 'Currency', 'Post Type Singular Name', 'text_domain' ),
		'menu_name' => __( 'Currencies', 'text_domain' ),
		'name_admin_bar' => __( 'Currency', 'text_domain' ),
		'archives' => __( 'Currency Archives', 'text_domain' ),
		'attributes' => __( 'Currency Attributes', 'text_domain' ),
		'parent_item_colon' => __( 'Parent Currency:', 'text_domain' ),
		'all_items' => __( 'All Currencies', 'text_domain' ),
		'add_new_item' => __( 'Add New Currency', 'text_domain' ),
		'add_new' => __( 'Add New', 'text_domain' ),
		'new_item' => __( 'New Currency', 'text_domain' ),
		'edit_item' => __( 'Edit Currency', 'text_domain' ),
		'update_item' => __( 'Update Currency', 'text_domain' ),
		'view_item' => __( 'View Currency', 'text_domain' ),
		'view_items' => __( 'View Currencies', 'text_domain' ),
		'search_items' => __( 'Search Currency', 'text_domain' ),
		'not_found' => __( 'Not found', 'text_domain' ),
		'not_found_in_trash' => __( 'Not found in Trash', 'text_domain' ),
		'featured_image' => __( 'Featured Image', 'text_domain' ),
		'set_featured_image' => __( 'Set featured image', 'text_domain' ),
		'remove_featured_image' => __( 'Remove featured image', 'text_domain' ),
		'use_featured_image' => __( 'Use as featured image', 'text_domain' ),
		'insert_into_item' => __( 'Insert into Currency', 'text_domain' ),
		'uploaded_to_this_item' => __( 'Uploaded to this Currency', 'text_domain' ),
		'items_list' => __( 'Currencies list', 'text_domain' ),
		'items_list_navigation' => __( 'Currencies list navigation', 'text_domain' ),
		'filter_items_list' => __( 'Filter Currencies list', 'text_domain' ),
	);
	$args = array(
		'label' => __( 'currency', 'text_domain' ),
		'description' => __( '', 'text_domain' ),
		'labels' => $labels,
...
add_action( 'init', 'pip_create_currency_cpt', 0 );



// Register Custom Post Type Glossary
// Post Type Key: Signal
