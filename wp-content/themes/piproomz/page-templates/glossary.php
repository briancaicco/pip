			...
			<div class="col-md-8 content-area" id="primary">
				...
				<div class="card">
					...
					<div class="card-body">
						...
						<h2 class="terms_heading">A</h2>
						<dl class="glossary-terms">
							<dt class="term">Accrual</dt>
							<dd class="definition">
								The apportionment of premiums and discounts on forward exchange transactions that relate directly to deposit swap (interest arbitrage) deals, over the period of each deal.
							</dd>
							<dt class="term">Adjustment</dt>
							<dd class="definition">
							...
							<dt class="term">Asian central banks</dt>
							<dd class="definition">
							...
							<dt class="term">Asian session</dt>
							<dd class="definition">
								23:00 – 08:00 GMT.
							</dd>
							<dt class="term">Ask (offer) price</dt>
							<dd class="definition">
								<p>The price at which the market is prepared to sell a product. Prices are quoted two-way as Bid/Ask. The Ask price is also known as the Offer.</p>
								<p>In FX trading, the Ask represents the price at which a trader can buy the base currency, shown to the left in a currency pair. For example, in the quote USD/CHF 1.4527/32, the base currency is USD, and the Ask price is 1.4532, meaning you can buy one US dollar for 1.4532 Swiss francs.</p>
								<p>In CFD trading, the Ask also represents the price at which a trader can buy the product. For example, in the quote for UK OIL 111.13/111.16, the product quoted is UK OIL and the Ask price is £111.16 for one unit of the underlying market.*</p>
							</dd>
							<dt class="term">At best</dt>
							<dd class="definition">
								An instruction given to a dealer to buy or sell at the best rate that can be obtained at a specific time.
							</dd>
							<dt class="term">At or better</dt>
							<dd class="definition">
								An instruction given to a dealer to buy or sell at a specific price or better.
							</dd>
							<dt class="term">AUS 200</dt>
							<dd class="definition">
				...
				<div class="section-wrapper glossary-section" id="terms-section_B" data-ie8-selector=":nth-of-type(odd)">
					<div class="wrapper">
						<h2 class="terms_heading">B</h2>
						<dl class="glossary-terms">
							<dt class="term">Balance of trade</dt>
							<dd class="definition">
								The value of a country's exports minus its imports.
							</dd>
							<dt class="term">Bar chart</dt>
							<dd class="definition">
								<p>A type of chart which consists of four significant points: the high and the low prices, which form the vertical bar; the opening price, which is marked with a horizontal line to the left of the bar; and the closing price, which is marked with a horizontal line to the right of the bar.</p>
							</dd>
							<dt class="term">Barrier level</dt>
							<dd class="definition">
							...
							<dt class="term">Barrier option</dt>
							<dd class="definition">
							...
							<dt class="term">Base currency</dt>
							<dd class="definition">
				...
				<div class="section-wrapper glossary-section" id="terms-section_C" data-ie8-selector=":nth-of-type(odd)">
					<div class="wrapper">
						<h2 class="terms_heading">C</h2>
						<dl class="glossary-terms">
							<dt class="term">Cable</dt>
							<dd class="definition">
							...
							<dt class="term">Corporate action</dt>
							<dd class="definition">
				...
				<div class="section-wrapper glossary-section" id="terms-section_D" data-ie8-selector=":nth-of-type(odd)">
					<div class="wrapper">
						<h2 class="terms_heading">D</h2>
						<dl class="glossary-terms">
							<dt class="term">Day trader</dt>
							<dd class="definition">
							...
							<dt class="term">Depreciation</dt>
							<dd class="definition">
								The decrease in value of an asset over time.
							</dd>
							<dt class="term">Derivative</dt>
							<dd class="definition">
							...
							<dt class="term">Divergence of MAs</dt>
							<dd class="definition">
				...
				<div class="section-wrapper glossary-section" id="terms-section_E" data-ie8-selector=":nth-of-type(odd)">
					<div class="wrapper">
						<h2 class="terms_heading">E</h2>
						<dl class="glossary-terms">
							<dt class="term">ECB</dt>
							<dd class="definition">
								European Central Bank, the central bank for the countries using the euro.
							</dd>
							<dt class="term">Economic indicator</dt>
							<dd class="definition">
								A government-issued statistic that indicates current economic growth and stability. Common indicators include employment rates, Gross Domestic Product (GDP), inflation, retail sales, etc.
							</dd>
							<dt class="term">End of day order (EOD)</dt>
							<dd class="definition">
							...
							<dt class="term">Eurozone Organization for Economic Co-operation and Development (OECD) leading indicator</dt>
							<dd class="definition">
				...
				<div class="section-wrapper glossary-section" id="terms-section_F" data-ie8-selector=":nth-of-type(odd)">
					<div class="wrapper">
						<h2 class="terms_heading">F</h2>
						<dl class="glossary-terms">
							<dt class="term">Factory orders</dt>
							<dd class="definition">
							...
							<dt class="term">Fill</dt>
							<dd class="definition">
								When an order has been fully executed.
							</dd>
							<dt class="term">Fill or kill</dt>
							<dd class="definition">
								An order that, if it cannot be filled in its entirety, will be cancelled.
							</dd>
							<dt class="term">First in first out (FIFO)</dt>
							<dd class="definition">
								All positions opened within a particular currency pair are liquidated in the order in which they were originally opened.
							</dd>
							<dt class="term">Fix</dt>
							<dd class="definition">
								<p>One of approximately five times during the forex trading day when a large amount of currency must be bought or sold to fill a commercial customer’s orders. Typically these times are associated with market volatility. The regular fixes are as follows (all times NY):&nbsp;
								</p>
								<p>5:00am - Frankfurt&nbsp;</p>
								<p>6:00am - London&nbsp;</p>
								<p>10:00am - WMHCO (World Market House Company)&nbsp;</p>
								<p>11:00am - WMHCO (World Market House Company) - more important&nbsp;</p>
								<p>8:20am - IMM</p>
								<p>8:15am - ECB</p>
							</dd>
							<dt class="term">Flat or flat reading</dt>
							<dd class="definition">
								Economic data readings matching the previous period's levels that are unchanged.
							</dd>
							<dt class="term">Flat/square</dt>
							<dd class="definition">
							...
							<dt class="term">Follow-through</dt>
							<dd class="definition">
							...
							<dt class="term">Foreign exchange/forex/FX</dt>
							<dd class="definition">
							...
							<dt class="term">FTSE 100</dt>
							<dd class="definition">
								The name of the UK 100 index.
							</dd>
							<dt class="term">Fundamental analysis</dt>
							<dd class="definition">
							...
							<dt class="term">Futures contract</dt>
							<dd class="definition">
				...
				<div class="section-wrapper glossary-section" id="terms-section_G" data-ie8-selector=":nth-of-type(odd)">
					<div class="wrapper">
						<h2 class="terms_heading">G</h2>
						<dl class="glossary-terms">
							<dt class="term">G7</dt>
							<dd class="definition">
							...
							<dt class="term">Gearing (also known as leverage)</dt>
							<dd class="definition">
							...
							<dt class="term">Gold certificate</dt>
							<dd class="definition">
							...
							<dt class="term">Gunning/gunned</dt>
							<dd class="definition">
				...
				<div class="section-wrapper glossary-section" id="terms-section_H" data-ie8-selector=":nth-of-type(odd)">
					<div class="wrapper">
						<h2 class="terms_heading">H</h2>
						<dl class="glossary-terms">
							<dt class="term">Handle</dt>
							<dd class="definition">
								Every 100 pips in the FX market starting with 000.
							</dd>
							<dt class="term">Hawk/hawkish</dt>
							<dd class="definition">
							...
							<dt class="term">Hedge</dt>
							<dd class="definition">
								A position or combination of positions that reduces the risk of your primary position.
							</dd>
							<dt class="term">Hit the bid</dt>
							<dd class="definition">
								To sell at the current market bid.
							</dd>
							<dt class="term">HK50/HKHI</dt>
							<dd class="definition">
				...
				<div class="section-wrapper glossary-section" id="terms-section_I" data-ie8-selector=":nth-of-type(odd)">
					<div class="wrapper">
						<h2 class="terms_heading">I</h2>
						<dl class="glossary-terms">
							<dt class="term">Illiquid</dt>
							<dd class="definition">
								Little volume being traded in the market; a lack of liquidity often creates choppy market conditions.
							</dd>
							<dt class="term">Illiquid</dt>
							<dd class="definition">
								Little volume being traded in the market; a lack of liquidity often creates choppy market conditions.&nbsp;<br style="color: #333333; font-family: Arial, Helvetica, Verdana, sans-serif; font-size: 12px; line-height: 18px; background-color: #ffffff;">
								<br style="color: #333333; font-family: Arial, Helvetica, Verdana, sans-serif; font-size: 12px; line-height: 18px; background-color: #ffffff;">
							</dd>
							<dt class="term">IMM</dt>
							<dd class="definition">
								International Monetary Market, the Chicago-based currency futures market, that is part of the Chicago Mercantile Exchange.
							</dd>
							<dt class="term">IMM futures</dt>
							<dd class="definition">
							...
							<dt class="term">IMM session</dt>
							<dd class="definition">
								8:00am - 3:00pm New York.
							</dd>
							<dt class="term">INDU</dt>
							<dd class="definition">
								Abbreviation for the Dow Jones Industrial Average.
							</dd>
							<dt class="term">Industrial production</dt>
							<dd class="definition">
							...
							<dt class="term">ISM non-manufacturing</dt>
							<dd class="definition">
				...
				<div class="section-wrapper glossary-section" id="terms-section_J" data-ie8-selector=":nth-of-type(odd)">
					<div class="wrapper">
						<h2 class="terms_heading">J</h2>
						<dl class="glossary-terms">
							<dt class="term">Japanese economy watchers survey</dt>
							<dd class="definition">
							...
							<dt class="term">Japanese machine tool orders</dt>
							<dd class="definition">
				...
				<div class="section-wrapper glossary-section" id="terms-section_K" data-ie8-selector=":nth-of-type(odd)">
					<div class="wrapper">
						<h2 class="terms_heading">K</h2>
						<dl class="glossary-terms">
							<dt class="term">Keep the powder dry</dt>
							<dd class="definition">
				...
				<div class="section-wrapper glossary-section" id="terms-section_L" data-ie8-selector=":nth-of-type(odd)">
					<div class="wrapper">
						<h2 class="terms_heading">L</h2>
						<dl class="glossary-terms">
							<dt class="term">Last dealing day</dt>
							<dd class="definition">
								The last day you may trade a particular product.
							</dd>
							<dt class="term">Last dealing time</dt>
							<dd class="definition">
								The last time you may trade a particular product.
							</dd>
							<dt class="term">Leading indicators</dt>
							<dd class="definition">
								Statistics that are considered to predict future economic activity.
							</dd>
							<dt class="term">Level</dt>
							<dd class="definition">
							...
							<dt class="term">Liquid market</dt>
							<dd class="definition">
								A market which has sufficient numbers of buyers and sellers for the price to move in a smooth manner.
							</dd>
							<dt class="term">Liquidation</dt>
							<dd class="definition">
								The closing of an existing position through the execution of an offsetting transaction.
							</dd>
							<dt class="term">London session</dt>
							<dd class="definition">
								08:00 – 17:00 (London).
							</dd>
							<dt class="term">Long position</dt>
							<dd class="definition">
				...
				<div class="section-wrapper glossary-section" id="terms-section_M" data-ie8-selector=":nth-of-type(odd)">
					<div class="wrapper">
						<h2 class="terms_heading">M</h2>
						<dl class="glossary-terms">
							<dt class="term">Macro</dt>
							<dd class="definition">
							...
							<dt class="term">Manufacturing production</dt>
							<dd class="definition">
							...
							<dt class="term">Maturity</dt>
							<dd class="definition">
								The date of settlement or expiry of a financial product.
							</dd>
							<dt class="term">Medley report</dt>
							<dd class="definition">
				...
				<div class="section-wrapper glossary-section" id="terms-section_O" data-ie8-selector=":nth-of-type(odd)">
					<div class="wrapper">
						<h2 class="terms_heading">O</h2>
						<dl class="glossary-terms">
							<dt class="term">Offer/ask price</dt>
							<dd class="definition">
				...
				<div class="section-wrapper glossary-section" id="terms-section_P" data-ie8-selector=":nth-of-type(odd)">
					<div class="wrapper">
						<h2 class="terms_heading">P</h2>
						<dl class="glossary-terms">
							<dt class="term">Paid</dt>
							<dd class="definition">
								Refers to the offer side of the market dealing.
							</dd>
							<dt class="term">Pair</dt>
							<dd class="definition">
								The forex quoting convention of matching one currency against the other.
							</dd>
							<dt class="term">Paneled</dt>
							<dd class="definition">
								A very heavy round of selling.
							</dd>
							<dt class="term">Parabolic</dt>
							<dd class="definition">
				...
				<div class="section-wrapper glossary-section" id="terms-section_Q" data-ie8-selector=":nth-of-type(odd)">
					<div class="wrapper">
						<h2 class="terms_heading">Q</h2>
						<dl class="glossary-terms">
							<dt class="term">Quantitative easing</dt>
							<dd class="definition">
								When a central bank injects money into an economy with the aim of stimulating growth.
							</dd>
							<dt class="term">Quarterly CFDs</dt>
							<dd class="definition">
								A type of future with expiry dates every three months (once per quarter).*
							</dd>
							<dt class="term">Quote</dt>
							<dd class="definition">
				...
				<div class="section-wrapper glossary-section" id="terms-section_R" data-ie8-selector=":nth-of-type(odd)">
					<div class="wrapper">
						...
						<dl class="glossary-terms">
							...
							<dt class="term">Risk</dt>
							<dd class="definition">
								Exposure to uncertain change, most often used with a negative connotation of adverse change.
							</dd>
							<dt class="term">Risk management</dt>
							<dd class="definition">
								The employment of financial analysis and trading techniques to reduce and/or control exposure to various types of risk.
							</dd>
							<dt class="term">Rollover</dt>
							<dd class="definition">
								<p>A rollover is the simultaneous closing of an open position for today's value date and the opening of the same position for the next day's value date at a price reflecting the interest rate differential between the two currencies.&nbsp;
								</p>
								<p>In the spot forex market, trades must be settled in two business days. For example, if a trader sells 100,000 Euros on Tuesday, then the trader must deliver 100,000 Euros on Thursday, unless the position is rolled over. As a service to customers, all open forex positions at the end of the day (5:00 PM New York time) are automatically rolled over to the next settlement date. The rollover (or swap) adjustment is simply the accounting of the cost-of-carry on a day-to-day basis. <a href="/en-ca/support/platform-handbooks#ForexTraderRollovers" class="">Learn more about FOREX.com's rollover policy</a></p>
							</dd>
							<dt class="term">Round trip</dt>
							<dd class="definition">
								A trade that has been opened and subsequently closed by an equal and opposite deal.
							</dd>
							<dt class="term">Running profit/loss</dt>
							<dd class="definition">
				...
				<div class="section-wrapper glossary-section" id="terms-section_S" data-ie8-selector=":nth-of-type(odd)">
					<div class="wrapper">
						<h2 class="terms_heading">S</h2>
						<dl class="glossary-terms">
							<dt class="term">SEC</dt>
							<dd class="definition">
								The Securities and Exchange Commission.
							</dd>
							<dt class="term">Sector</dt>
							<dd class="definition">
								A group of securities that operate in a similar industry.
							</dd>
							<dt class="term">Sell</dt>
							<dd class="definition">
								Taking a short position in expectation that the market is going to go down.
							</dd>
							<dt class="term">Settlement</dt>
							<dd class="definition">
							...
							<dt class="term">Short squeeze</dt>
							<dd class="definition">
							...
							<dt class="term">Simple moving average SMA</dt>
							<dd class="definition">
							...
							<dt class="term">Stop entry order</dt>
							<dd class="definition">
							...
							<dt class="term">Stop-loss hunting</dt>
							<dd class="definition">
							...
							<dt class="term">Stop loss order</dt>
							<dd class="definition">
							...
							<dt class="term">Stops building</dt>
							<dd class="definition">
				...
				<div class="section-wrapper glossary-section" id="terms-section_T" data-ie8-selector=":nth-of-type(odd)">
					<div class="wrapper">
						...
						<dl class="glossary-terms">
							...
							<dt class="term">Trailing stop</dt>
							<dd class="definition">
							...
							<dt class="term">Transaction cost</dt>
							<dd class="definition">
								The cost of buying or selling a financial product.
							</dd>
							<dt class="term">Transaction date</dt>
							<dd class="definition">
								The date on which a trade occurs.
							</dd>
							<dt class="term">Trend</dt>
							<dd class="definition">
				...
				<div class="section-wrapper glossary-section" id="terms-section_U" data-ie8-selector=":nth-of-type(odd)">
					<div class="wrapper">
						<h2 class="terms_heading">U</h2>
						<dl class="glossary-terms">
							<dt class="term">Ugly</dt>
							<dd class="definition">
								Describing unforgiving market conditions that can be violent and quick.
							</dd>
							<dt class="term">UK average earnings including bonus/excluding bonus</dt>
							<dd class="definition">
							...
							<dt class="term">UK claimant count rate</dt>
							<dd class="definition">
							...
							<dt class="term">UK HBOS house price index</dt>
							<dd class="definition">
							...
							<dt class="term">University of Michigan's consumer sentiment index</dt>
							<dd class="definition">
							...
							<dt class="term">Unrealized gain/loss</dt>
							<dd class="definition">
				...
				<div class="section-wrapper glossary-section" id="terms-section_V" data-ie8-selector=":nth-of-type(odd)">
					<div class="wrapper">
						<h2 class="terms_heading">V</h2>
						<dl class="glossary-terms">
							<dt class="term">Value date</dt>
							<dd class="definition">
				...
				<div class="section-wrapper glossary-section" id="terms-section_W" data-ie8-selector=":nth-of-type(odd)">
					<div class="wrapper">
						<h2 class="terms_heading">W</h2>
						<dl class="glossary-terms">
							<dt class="term">Wedge chart pattern</dt>
							<dd class="definition">
				...
				<div class="section-wrapper glossary-section" id="terms-section_X" data-ie8-selector=":nth-of-type(odd)">
					<div class="wrapper">
						<h2 class="terms_heading">X</h2>
						<dl class="glossary-terms">
							<dt class="term">XAG/USD</dt>
							<dd class="definition">
								Symbol for Silver Index.
							</dd>
							<dt class="term">XAU/USD</dt>
							<dd class="definition">
								Symbol for Gold Index.
							</dd>
							<dt class="term">XAX.X</dt>
							<dd class="definition">
				...
				<div class="section-wrapper glossary-section" id="terms-section_Y" data-ie8-selector=":nth-of-type(odd)">
					<div class="wrapper">
						<h2 class="terms_heading">Y</h2>
						<dl class="glossary-terms">
							<dt class="term">Yard</dt>
							<dd class="definition">
								A billion units.
							</dd>
							<dt class="term">Yield</dt>
							<dd class="definition">
								The percentage return from an investment.
							</dd>
							<dt class="term">YoY</dt>
							<dd class="definition">
								Abbreviation for year over year.
							</dd>
							<dt class="term">Yuan</dt>
							<dd class="definition">
				...
				<div class="section-wrapper glossary-section" id="terms-section_Z" data-ie8-selector=":nth-of-type(odd)">
					<div class="wrapper">
						<h2 class="terms_heading">Z</h2>
						<dl class="glossary-terms">
						</dl>
					</div>
				</div>
