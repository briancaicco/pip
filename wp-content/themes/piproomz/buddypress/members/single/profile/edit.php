...
<form action="<?php bp_the_profile_group_edit_form_action(); ?>" method="post" id="profile-edit-form" class="standard-form <?php bp_the_profile_group_slug(); ?>">
	...
	<?php
		...
		<h2><?php printf( __( "Editing '%s' Profile Room", 'buddypress' ), bp_get_the_profile_group_name() ); ?></h2>
	...
	<div class="submit">
		<input type="submit" class="btn btn-lg btn-success" name="profile-group-edit-submit" id="profile-group-edit-submit" value="<?php esc_attr_e( 'Save Changes', 'buddypress' ); ?> " />
	</div>
