...
<form action="<?php bp_messages_form_action('compose' ); ?>" method="post" id="send_message_form" class="standard-form" enctype="multipart/form-data">
	...
	<ul class="first acfb-holder">
		<li>
			<div class="form-group">
				...
				<input type="text" name="send-to-input" class="form-control" id="send-to-input" />
			</div>
		</li>
	</ul>
	...
	<?php if ( bp_current_user_can( 'bp_moderate' ) ) : ?>
		<div class="form-check pl-3">
			<label for="send-notice">
				<input type="checkbox" class="form-check-input" id="send-notice" name="send-notice" value="1" /> 
	...
	<div class="form-group">
		...
		<textarea name="content" class="form-control" id="message_content" rows="15" cols="40"><?php bp_messages_content_value(); ?></textarea>
	</div>
	...
	<div class="submit clearfix">
		<input type="submit" class="btn btn-lg btn-success float-right" value="<?php esc_attr_e( "Send Message", 'buddypress' ); ?>" name="send" id="send" />
	</div>
