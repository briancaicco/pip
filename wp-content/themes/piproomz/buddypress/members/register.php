...
<script>
	...
	jQuery(document).ready(function() {
		...
		<div class="row justify-content-center">
			<div class="col-12 col-md-5 mt-4 mt-md-5">
						...
						<form action="" name="signup_form" id="signup_form" class="standard-form" method="post" enctype="multipart/form-data">
										...
										<?php if ( bp_is_active( 'xprofile' ) ) : if ( bp_has_profile( array( 'profile_group_id' => 1, 'fetch_field_data' => false ) ) ) : while ( bp_profile_groups() ) : bp_the_profile_group(); ?>
											...
											<?php while ( bp_profile_fields() ) : bp_the_profile_field(); ?>
												...
												<p class="field-visibility-settings-toggle" id="field-visibility-settings-toggle-<?php bp_the_profile_field_id() ?>">
													...
													<button type="button" class="btn btn-success btn-sm visibility-toggle-link" aria-describedby="<?php bp_the_profile_field_input_name(); ?>-2" aria-expanded="false"><?php _ex( 'Change', 'Change profile field visibility level', 'buddypress' ); ?></button>
												</p>
							...
							<?php
								...
								<div class="submit pt-3">
									<input class="btn btn-lg btn-success" type="submit" name="signup_submit" id="signup_submit" value="<?php esc_attr_e( 'Complete Request', 'buddypress' ); ?>" />
								</div>
