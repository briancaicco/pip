...
<div id="buddypress">
	...
	<form action="" method="post" id="blogs-directory-form" class="dir-form">
		...
		<div class="item-list-tabs nav-justified"" aria-label="<?php esc_attr_e( 'Sites directory main navigation', 'buddypress' ); ?>" role="navigation">
			<ul>
		...
		<div class="item-list-tabs nav-justified"" id="subnav" aria-label="<?php esc_attr_e( 'Sites directory secondary navigation', 'buddypress' ); ?>" role="navigation">
			<ul>
