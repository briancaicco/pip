	...
	<div class="card">
		<div class="card-body">
			...
			<div class="activity-content">
				...
				<div class="activity-header small">
				...
				<?php if ( bp_activity_has_content() ) : ?>
					...
					<div class="activity-inner mt-2 mb-4">
					...
					<?php if ( is_user_logged_in() ) : ?>
						...
						<?php if ( bp_activity_can_favorite() ) : ?>
							...
							<?php if ( !bp_get_activity_is_favorite() ) : ?>
								...
								<a href="<?php bp_activity_favorite_link(); ?>" class="button fav bp-secondary-action"><i class="fa fa-thumbs-o-up" aria-hidden="true"></i></a>

							<?php else : ?>

								<a href="<?php bp_activity_unfavorite_link(); ?>" class="button unfav bp-secondary-action"><i class="fa fa-thumbs-up" aria-hidden="true"></i></a>
					...
					<?php if ( is_user_logged_in() && bp_activity_can_comment() ) : ?>
						...
						<form action="<?php bp_activity_comment_form_action(); ?>" method="post" id="ac-form-<?php bp_activity_id(); ?>" class="ac-form"<?php bp_activity_comment_form_nojs_display(); ?>>
							...
							<div class="ac-reply-content">
								...
								<input type="submit" name="ac_form_submit" class="btn btn-success"value="<?php esc_attr_e( 'Post', 'buddypress' ); ?>" /> &nbsp; <a href="#" class="ac-reply-cancel"><?php _e( 'Cancel', 'buddypress' ); ?></a>
