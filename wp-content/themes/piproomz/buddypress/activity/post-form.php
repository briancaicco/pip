...
<div class=" bg-light p-3 pt-4 pb-1 mt-2 br-0">
	<div class="">
			...
			<div id="whats-new-content">
				...
				<div id="whats-new-options">
					<div id="whats-new-submit">
						<input type="submit" class="btn btn-success" name="aw-whats-new-submit" id="aw-whats-new-submit" value="<?php esc_attr_e( 'Publish', 'buddypress' ); ?>" />
					</div>
					...
					<?php if ( bp_is_active( 'groups' ) && !bp_is_my_profile() && !bp_is_group() ) : ?>
						...
						<div id="whats-new-post-in-box">
							...
							<select id="whats-new-post-in" name="whats-new-post-in" class="custom-select">
