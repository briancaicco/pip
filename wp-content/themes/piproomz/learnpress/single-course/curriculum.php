...
?>
<div class="course-curriculum mt-3" id="learn-press-course-curriculum">
	...
	<?php else: ?>
		<p><?php echo apply_filters( 'learn_press_course_curriculum_empty', __( 'Curriculum is empty', 'learnpress' ) ); ?></p>
	<?php endif; ?>
