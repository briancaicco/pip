	...
	if ( $can_purchase ) {
		...
		if ( $external_link = $course->get_external_link() ) {
            ...
            <div class="purchase-course">
                <a href="<?php echo esc_url( $external_link ); ?>" class="purchase-button btn btn-success">
		...
		<?php } else { ?>
            ...
            <form name="purchase-course" class="purchase-course" method="post" enctype="multipart/form-data">
                ...
                <button class="button purchase-button btn btn-success" data-block-content="yes">
		...
		if ( $course->is_required_enroll() ) {
			...
			if ( $user->has( 'finished-course', $course->id ) ): ?>
				<?php if ( $count = $user->can( 'retake-course', $course->id ) ): ?>
                    <button
                            class="button button-retake-course btn btn-success"
            ...
            elseif ( $user->has( 'enrolled-course', $course->id ) ): ?>
                ...
                <button
                        ...
                        class="button-finish-course<?php echo ! $can_finish ? ' hide-if-js' : ''; ?> btn btn-success"
			...
			<?php elseif ( $user->can( 'enroll-course', $course->id ) === true ) : ?>
                <form name="enroll-course" class="enroll-course" method="post" enctype="multipart/form-data">
                    ...
                    <button class="button enroll-button btn btn-success"
