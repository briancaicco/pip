			...
			<div class="container-fluid p-0">
				<nav class="primary-nav navbar navbar-expand-md navbar-fixed-top dashboard ">
					...
					<ul class="navbar-nav mr-auto align-items-stretch">
						...
						<?php if(!current_user_can('mepr-active','rule: 4007, 204, 200, 4124')) { ?>
							<div>
						...
						<?php } elseif(current_user_can('mepr-active','rule: 4124, 204')) { ?>
							<div class="mr-3 badge badge-success text-light">Pro Member</div>  
						<?php } else{ ?>
							<div class="mr-3 py-2 badge badge-success text-light">Basic Member</div> 
						<? }?>
