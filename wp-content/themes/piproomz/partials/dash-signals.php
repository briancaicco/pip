			...
			<div class="card mb-3 signal border-0 ">
				<div class="card-body">
					...
					<div class="d-flex justify-content-between">
						...
						<p><?php printf( _x( '%s ago', '%s = human-readable time difference', 'your-text-domain' ), human_time_diff( get_the_time( 'U' ), current_time( 'timestamp' ) ) ); ?></p>
					</div>
					<!-- Signal Action -->
					<h2><b><?php the_field('action'); ?></b></h2>
					<p class="lead"><b>@ <?php the_field('open_price'); ?></b></p>
					<!-- Signal Positions -->
