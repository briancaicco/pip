...
<div class="mp_wrapper mp_login_form">
	...
	<?php else: ?>
		...
		<form name="mepr_loginform" id="mepr_loginform" class="standard-form px-4 pt-0 pb-4" action="<?php echo $login_url; ?>" method="post">
			<div class="input-group input-group-lg mt-3 py-2">
				...
				<input type="text" name="log" id="user_login" class="input form-control" value="<?php echo (isset($_POST['log'])?$_POST['log']:''); ?>" placeholder="Username or E-mail" />
			</div>
			<div class="input-group input-group-lg mt-3 py-2">
				<span class="input-group-addon" id="sizing-addon1"><i class="fa fa-lock" aria-hidden="true"></i></span>
				<input type="password" name="pwd" id="user_pass" class="input form-control" value="<?php echo (isset($_POST['pwd'])?$_POST['pwd']:''); ?>" placeholder="Password" />
			</div>
			<div class="input-group input-group-lg border-0 mt-2 py-2">
				<button type="checkbox" class="btn btn-sm btn-switch" name="rememberme" data-toggle="button" value="forever" aria-pressed="false" autocomplete="off">
		...
		<div class="mepr-login-actions px-4 pt-0 pb-4">
