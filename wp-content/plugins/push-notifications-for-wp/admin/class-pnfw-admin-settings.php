...
class PNFW_Admin_Settings {
 ...
 private static function print_android_advanced_box($pnfw_use_notification_message) { ?>
  ...
  <!-- //-postbox -->
 <?php }
 private static function print_misc_box($pnfw_use_wpautop, $pnfw_disable_email_verification, $pnfw_use_multiple_background_processes, $pnfw_uninstall_data, $pnfw_force_badge_count) { ?>
  <!-- postbox -->
  <div class="postbox">
   <div class="inside">
    <p>
